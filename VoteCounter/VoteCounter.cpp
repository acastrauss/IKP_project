...
#include "ThreadCountVotes/ThreadCountVotes.h"
...
int main()
{
    std::cout << "Press enter to start counter." << std::endl;
    std::getchar();
    ...
    std::cout << "Press enter to end counter." << std::endl;
    std::getchar();
...
DWORD __stdcall Sum(LPVOID lpParam)
{
